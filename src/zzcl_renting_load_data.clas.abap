CLASS zzcl_renting_load_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZZCL_RENTING_LOAD_DATA IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.


    DATA: lt_brands    TYPE TABLE OF zzrent_brands,
          lt_cars      TYPE TABLE OF zzrent_cars,
          lt_customers TYPE TABLE OF zzrent_customers.
** BRANDS **
    lt_brands = VALUE #(
    ...
    DELETE FROM zzrent_brands.
    INSERT zzrent_brands FROM TABLE @lt_brands.
    SELECT * FROM zzrent_brands INTO TABLE
    @lt_brands.
    out->write( sy-dbcnt ).
    out->write( 'zrent_brands_a10 data inserted successfully!' ).
...
** CARS**
    lt_cars = VALUE #(
        ...
        ( matricula = '2174FHF' marca = 'KIA' modelo = 'CEED' color = 'AZUL' motor = '4.2' potencia = '340' und_potencia = 'CV'
        ...
        ( matricula = '2392JFH' marca = 'JEEP' modelo = 'GRAND CHEROKEE' color = 'BLANCO' motor = '3.6' potencia = '176' und_potencia = 'CV'
            combustible = 'GASOLINA' consumo = '12.00' fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20250601' alq_hasta = '20251001' )
    ...
    DELETE FROM zzrent_cars.
    INSERT zzrent_cars FROM TABLE @lt_cars.
    SELECT * FROM zzrent_cars INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
    out->write( 'zrent_cars_a10 data inserted successfully!' ).
...
** CUSTOMERS**
    ...
    DELETE FROM zzrent_customers.
    INSERT zzrent_customers FROM TABLE @lt_customers.
    SELECT * FROM zzrent_customers INTO TABLE
    @lt_customers.
    out->write( sy-dbcnt ).
