...
CLASS zcl_books_load_data IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ_83,
          lt_catego    TYPE TABLE OF ztb_catego_8083,
          lt_clientes  TYPE TABLE OF ztb_clientes_083,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_83,
          lt_libros    TYPE TABLE OF ztb_libros_8083.
...
** Categorias **
    ...
    DELETE FROM ztb_catego_8083.
    INSERT ztb_catego_8083 FROM TABLE @lt_catego.
    SELECT * FROM ztb_catego_8083 INTO TABLE @lt_catego.
    out->write( sy-dbcnt ).
    out->write( 'ztb_catego_8083 data inserted successfully!' ).


** Categorias y Accesos**
    lt_acc_categ = VALUE #(
    ...
    DELETE FROM ztb_acc_categ_83.
    INSERT ztb_acc_categ_83 FROM TABLE @lt_acc_categ.
    SELECT * FROM ztb_acc_categ_83 INTO TABLE @lt_acc_categ.
    out->write( sy-dbcnt ).
    out->write( 'ztb_acc_categ_83 data inserted successfully!' ).
...
** Clientes **
    ...
    DELETE FROM ztb_clientes_083.
    INSERT ztb_clientes_083 FROM TABLE @lt_clientes.
    SELECT * FROM ztb_clientes_083 INTO TABLE @lt_clientes.
    out->write( sy-dbcnt ).
    out->write( 'ztb_clientes_083 data inserted successfully!' ).
...
** Libros **
    ...
    DELETE FROM ztb_libros_8083.
    INSERT ztb_libros_8083 FROM TABLE @lt_libros.
    SELECT * FROM ztb_libros_8083 INTO TABLE @lt_libros.
    out->write( sy-dbcnt ).
    out->write( 'ztb_libros_8083 data inserted successfully!' ).
...
** Clientes y Libros **
    ...
    DELETE FROM ztb_clnts_lib_83.
    INSERT ztb_clnts_lib_83 FROM TABLE @lt_clnts_lib.
    SELECT * FROM ztb_clnts_lib_83 INTO TABLE @lt_clnts_lib.
    out->write( sy-dbcnt ).
    out->write( 'ztb_acc_categ_83 data inserted successfully!' ).
